...
def buy_etf(code):
    ...
    try:
        ...
        if current_price > target_price and current_price > ma5_price \
            ...
            # 5:조건부, 12:최유리(당장 가장 유리하게 매매할 수 있는 가격, 13:최우선(우선 대기하는 가격)
            # 매수 주문 요청
...
if __name__ == '__main__':
    try:
        symbol_list = ['A001440', 'A010170', 'A006730', 'A022100', 'A00680K', '002350', 'A012610',
                       'A364960', 'A364970', 'A364980', 'A364990', 'A365000']  # 자동매매하고자 하는 종목 티커(주식,뉴딜etf)
